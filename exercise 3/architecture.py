...
OPS = {
    ...
    "inc": {"code": 0xC, "fmt": "r-"},  # increases register by 1
    "dec": {"code": 0xD, "fmt": "r-"},  # decreases register by 1
    "swp": {"code": 0xE, "fmt": "rr"},  # swap two values
    "bt0": {"code": 0xF, "fmt": "rv"}   # branch if bigger or equal to 0
